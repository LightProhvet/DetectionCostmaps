...
Current changes:
* rename param on line 151:   std::string semantic_map_topic_;
* rename StaticLayer -> SemanticLayer and similar occurences
* rename namespace on line 27

 *********************************************************************/
#ifndef SEMANTIC_COSTMAP__SEMANTIC_LAYER_HPP_
#define SEMANTIC_COSTMAP__SEMANTIC_LAYER_HPP_
...
protected:
  ...
  /**
   * @brief Interpret the value in the semantic map given on the topic to
